<section class="content">
        <div class="container-fluid">
			...
			<?php if(isset($file_data) && count($file_data)=='0' && isset($floder_data) && count($floder_data)=='0' && isset($link_data) && count($link_data)=='0'){ ?>
				<div>
			...
			<?php if(isset($link_data) && count($link_data)>0){ ?>
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
						...
						<div class="row clearfix">
						<?php //echo '<pre>';print_r($file_data);exit; ?>
						<?php $cnt=1;foreach($link_data as $list){ ?>
								<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
									<div class="card">
									<ul class="header-dropdown m-r--5">
												<li class="dropdown">
													<a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
													 ...
													 <ul class="dropdown-menu pull-right">
														<li><a href="<?php echo base_url('recyclebin/linkrestore/'.base64_encode($list->l_id)); ?>">Restore</a></li>
														<li><a href="<?php echo base_url('recyclebin/linkdelte/'.base64_encode($list->l_id)); ?>">Delete</a></li>
													</ul>
												</li>
											</ul>
										<div class="header help-class folder-ti">
												<label > &nbsp; <?php echo htmlentities($list->l_name); ?></label>
